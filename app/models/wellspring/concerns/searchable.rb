module Beknown
  module Concerns
    module Searchable
      ...
      included do
        has_many :search_data, class_name: 'Beknown::EntrySearchData'
      ...
      module ClassMethods
        ...
        def search(query)
          select('DISTINCT ON (entry_id) entry_id, beknown_entries.*').
            joins(:search_data).
      ...
      def update_search_index
        Beknown::EntrySearchData.index_entry_data(id, search_attributes)
      end
    end
  end
end